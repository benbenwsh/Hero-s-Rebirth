...
public class Enemy: MonoBehaviour
{
    ...
    [SerializeField] private BoxCollider2D weaponBoxCollider;
    ...
    public void TakeDamage(int damage, Vector2 knockback, int knockbackMultiplier, BoxCollider2D weaponBoxCollider)
    {
        if (!invincible)
        {
            hp -= damage;
            ...
            if (hp > 0)
            {
                ...
                this.weaponBoxCollider = weaponBoxCollider;
                invincible = true;
    ...
    protected void Die(Vector2 knockback)
    {
        isDead = true;
